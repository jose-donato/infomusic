 ...
 *
 */
public class RMIServerBackup extends UnicastRemoteObject implements InterfaceServer {
    private static final long serialVersionUID = 1L;
    static InterfaceClient client;

    public static  String TCPAddress = null;
    protected RMIServerBackup() throws RemoteException {
        super();
    }
     ...
     */
    public static void main(String[] args) throws InterruptedException, MalformedURLException, NotBoundException, RemoteException {
