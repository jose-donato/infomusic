...
public class RMIClient extends UnicastRemoteObject implements InterfaceClient {
    ...
    public static boolean menu(InterfaceServer i, String username, InterfaceClient iClient) throws IOException, SQLException, NotBoundException, InterruptedException {
